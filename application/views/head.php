...
<link rel="stylesheet" type="text/css" href="<?php echo base_url(''); ?>libs/select-multi/multi.min.css"> <!-- original -->
<link rel="stylesheet" type="text/css" href="<?php echo base_url(''); ?>libs/select2/css/select2.min.css"> <!-- Customization -->
