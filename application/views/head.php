<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/'); ?>styles/common.min.css">
    <!-- END GLOBAL MANDATORY STYLES -->


    <!-- BEGIN THEME STYLES -->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/admin/'); ?>styles/themes/primary.min.css">
    <link class="ks-sidebar-dark-style" rel="stylesheet" type="text/css" href="<?php echo base_url('assets/admin/'); ?>styles/themes/sidebar-black.min.css">
    <!-- END THEME STYLES -->
...
<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/a'); ?>styles/dashboard/tabbed-sidebar.min.css">

<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/'); ?>libs/select-multi/multi.min.css"> <!-- original -->
<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/'); ?>libs/select2/css/select2.min.css"> <!-- Customization -->

<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/'); ?>styles/pages/auth.min.css">
</head>