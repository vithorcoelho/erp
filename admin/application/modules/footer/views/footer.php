...
<script src="<?php echo str_replace('admin/', '', base_url()) ?>libs/responsejs/response.min.js"></script>
<script src="<?php echo str_replace('admin/', '', base_url()) ?>libs/tether/js/tether.min.js"></script>
<script src="<?php echo str_replace('admin/', '', base_url()) ?>libs/jscrollpane/jquery.jscrollpane.min.js"></script>
<script src="<?php echo str_replace('admin/', '', base_url()) ?>libs/jscrollpane/jquery.mousewheel.js"></script>
